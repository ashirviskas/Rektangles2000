...
def build_model():
    ...
    x = Conv2D(256, (5, 5), strides=(1, 1), activation='relu', padding='same')(input)
    ...
    encoded = Conv2D(64, (4, 4), strides=(2, 2), activation=binary_activation, padding='same')(x)

    # x = UpSampling2D((2, 2))(encoded)
    x = Conv2D(256, (2, 2), strides=(1, 1), activation='relu', padding='same')(encoded)
    x = add_residual(x, 64)
